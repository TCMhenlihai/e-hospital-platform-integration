...
def model_predict(uploaded_files, model):
    ...
    for path in uploaded_files:
        ...
        for count, i in enumerate(signals):
            ...
            if pred_class == 0:
                APC.append(str(indices[count]))
            elif pred_class == 1:
                NORMAL.append(str(indices[count]))
            elif pred_class == 2:    
                LBB.append(str(indices[count]))
            elif pred_class == 3:
                PAB.append(str(indices[count]))
            elif pred_class == 4:
                PVC.append(str(indices[count]))
            elif pred_class == 5:
                RBB.append(str(indices[count]))
            elif pred_class == 6:
                VEB.append(str(indices[count]))

        print(result)
        sorted_result = sorted(result.items(), key = lambda y: len(y[1]))[::-1]
        # print(sorted_result)
        # output.append(result)

        data = {}
        data['filename'+str(flag)] = str(path)
        data['result'+str(flag)] = str(sorted_result)
...
#     ,"filename1": "D:\\Projects\\ECG-Arrhythmia-Diagnostic-customized-master\\uploads\\sample.csv", "result1": "[('PVC', [(430, 706)]), ('Normal', [(240, 431)]), ('VEB', []), ('RBB', []), ('PAB', []), ('LBB', []), ('APC', [])]","filename1": "D:\\Projects\\ECG-Arrhythmia-Diagnostic-customized-master\\uploads\\sample.csv", "result1": "[('PVC', [(430, 706)]), ('Normal', [(240, 431)]), ('VEB', []), ('RBB', []), ('PAB', []), ('LBB', []), ('APC', [])]","filename1": "D:\\Projects\\e-hospital-2023-main\\uploads\\sample.csv", "result1": "[('PVC', [(430, 706)]), ('Normal', [(240, 431)]), ('VEB', []), ('RBB', []), ('PAB', []), ('LBB', []), ('APC', [])]","filename1": "D:\\Projects\\e-hospital-2023-main\\uploads\\sample.csv", "result1": "[('PVC', [(430, 706)]), ('Normal', [(240, 431)]), ('VEB', []), ('RBB', []), ('PAB', []), ('LBB', []), ('APC', [])]","filename1": "D:\\Projects\\e-hospital-2023-main\\uploads\\sample.csv", "result1": "[('PVC', [(430, 706)]), ('Normal', [(240, 431)]), ('VEB', []), ('RBB', []), ('PAB', []), ('LBB', []), ('APC', [])]","filename1": "D:\\Projects\\e-hospital-2023-main\\uploads\\sample.csv", "result1": "[('PVC', [(430, 706)]), ('Normal', [(240, 431)]), ('VEB', []), ('RBB', []), ('PAB', []), ('LBB', []), ('APC', [])]","filename1": "D:\\Projects\\e-hospital-2023-main\\uploads\\sample.csv", "result1": "[('PVC', [(430, 706)]), ('Normal', [(240, 431)]), ('VEB', []), ('RBB', []), ('PAB', []), ('LBB', []), ('APC', [])]"
